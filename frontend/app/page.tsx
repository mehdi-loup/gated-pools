          ...
          <div className="max-w-4xl">
            <h1 className="text-6xl font-bold mb-6">
              ...
              <span className="text-accent block mt-2">
                for DAOs & Foundations
              </span>
            </h1>
            <p className="text-xl mb-8 opacity-90">
              Private, low-fee swapping environment verified via email proofs.
              Built on Uniswap v4 with MEV protection and seamless cross-chain
              routing.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card bg-base-100 shadow-xl token-card">
              <div className="card-body text-center">
                ...
                <p>
                  Email-verified access ensures only authorized employees can
                  trade
                </p>
              </div>
            </div>
            <div className="card bg-base-100 shadow-xl token-card">
              <div className="card-body text-center">
                ...
                <p>
                  Eliminate slippage loss to MEV bots with restricted pool
                  access
                </p>
              </div>
            </div>
            <div className="card bg-base-100 shadow-xl token-card">
              <div className="card-body text-center">
                ...
                <p>
                  Seamless swapping across multiple chains with unified
                  liquidity
                </p>
              </div>
            </div>
